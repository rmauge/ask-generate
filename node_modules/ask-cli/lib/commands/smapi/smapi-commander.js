...
const { kebabCase } = require("../../utils/string-utils");
const { CliCustomizationProcessor } = require("./cli-customization-processor");
const optionModel = require("../option-model.json");
const handler = require("./smapi-command-handler");
const aliases = require("./customizations/aliases.json");
const { apiToCommanderMap } = require("./customizations/parameters-map");
const metricClient = require("../../utils/metrics");
