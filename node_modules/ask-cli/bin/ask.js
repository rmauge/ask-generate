...
require("../lib/commands/configure").createCommand(commander);
require("../lib/commands/deploy").createCommand(commander);
require("../lib/commands/new").createCommand(commander);
require("../lib/commands/init").createCommand(commander);
require("../lib/commands/dialog").createCommand(commander);
require("../lib/commands/run").createCommand(commander);
