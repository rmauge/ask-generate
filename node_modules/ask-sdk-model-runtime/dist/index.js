...
exports.createUserAgent = exports.LwaServiceClient = exports.BaseServiceClient = exports.DefaultApiClient = void 0;
var url = require("url");
/**
        ...
        return new Promise(function (resolve, reject) {
            var clientRequest = client.request(clientRequestOptions, function (response) {
                ...
                response.on('end', function () {
                    var responseStr = Buffer.concat(chunks).toString();
                    var responseObj = {
...
var BaseServiceClient = /** @class */ (function () {
    ...
    BaseServiceClient.prototype.invoke = function (method, endpoint, path, pathParams, queryParams, headerParams, bodyParam, errors, nonJsonBody) {
        return __awaiter(this, void 0, void 0, function () {
            var request, contentType, contentTypeNonJson, apiClient, response, _i, _a, requestInterceptor, _b, _c, responseInterceptor, err_1, body, apiResponse, err;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        if (bodyParam != null) {
                            contentType = headerParams.find(function (header) { return header.key.toLowerCase() === 'content-type'; });
                            contentTypeNonJson = contentType && !contentType.value.includes('application/json');
...
var LwaServiceClient = /** @class */ (function (_super) {
    ...
    LwaServiceClient.prototype.generateAccessToken = function (accessTokenRequest) {
        return __awaiter(this, void 0, void 0, function () {
            var authEndpoint, queryParams, headerParams, pathParams, paramInfo, bodyParams, errorDefinitions, apiResponse, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
